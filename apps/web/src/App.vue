...
<template>
  ...
  <main v-else class="app-shell">
    <nav class="app-rail">
      <button class="rail-avatar" title="我" @click="goSettingsPage">
        {{ (displayName || identity?.user_id || '?').slice(0, 1).toUpperCase() }}
      </button>
      <button class="rail-item" :class="{ active: currentPage === 'chat' }" @click="goChatHome">
      ...
      <button class="rail-item" :class="{ active: currentPage === 'contacts' }" @click="goContactsPage">
      ...
      <button class="rail-item" :class="{ active: currentPage === 'settings' || currentPage === 'diagnostics' }" @click="goSettingsPage">
