export default {
  ...
  settingsView: {
    ...
    exportIdentity: '导出身份',
    fullDataBackup: '完整数据备份',
    fullDataBackupDescription: '加密导出本机联系人、消息和设置；可用于换设备恢复。',
    hideBackup: '隐藏',
    showBackup: '显示备份',
    generateBackup: '生成备份',
    downloadBackup: '下载备份',
  ...
  importFullDataBackupTitle: '导入完整数据备份', importFullDataBackupMessage: '导入会覆盖当前身份的本地联系人、群聊、消息和待发送队列。继续导入？', importFullDataBackupSuccess: '完整数据备份已导入',
  mergeFullDataBackupFailed: '合并完整数据备份失败', saveSyncSettingsTitle: '保存消息同步设置', loginFailed: '登录失败', retryInput: '重新输入',
