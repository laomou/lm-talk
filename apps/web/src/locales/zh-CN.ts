export default {
  ...
  settingsView: {
    ...
    displayName: '显示名',
    avatar: '头像',
    avatarHint: '支持图片，上传后自动压缩到 128×128，最大 64KB。',
    changeAvatar: '更换头像',
    removeAvatar: '移除头像',
    save: '保存', saving: '保存中…', processingAvatar: '处理中…',
    profileSaved: '个人资料已保存',
    profileSavedAndSynced: '个人资料已保存并同步',
    profileSavedPendingSync: '个人资料已保存，等待下次同步',
  ...
  securityStatus: '安全状态',
    ...
    securityNormal: '安全状态正常',
    refreshSecurityInfo: '刷新安全信息',
    repairSendBlockers: '修复发送阻断',
    securityInfoUpToDateTitle: '安全信息已是最新',
    securityInfoUpToDateMessage: '当前没有需要刷新的联系人安全信息。',
    securityInfoRefreshedTitle: '安全信息已刷新',
    securityInfoRefreshedMessage: '安全状态正常，可以继续聊天。',
    securityInfoPartialTitle: '安全信息未完全刷新',
    securityStillBlockedTitle: '安全状态仍需修复',
    securityRepairedTitle: '安全状态已修复',
    autoProtect: '自动保护',
    device: '设备',
    ...
    failed: '失败：{count}',
    incomingRecoverySummary: '接收恢复：{count} 条，{summary}',
    incomingRecoveryFallback: '等待重试',
    diagnostics: '诊断',
  ...
  avatarProcessingFailed: '头像处理失败', avatarImageOnly: '请选择图片文件。', avatarTooLarge: '头像压缩后仍超过 64KB，请选择更小的图片。', profileSaveFailed: '保存个人资料失败',
  ...
  deleteMessageTitle: '删除消息', deleteMessageMessage: '删除这条消息？这只会删除本机记录和相关待发送项，无法恢复。',
  ...
  removeAvatarTitle: '移除头像', removeAvatarMessage: '移除当前头像？好友将在下次同步后看到字母头像。',
  ...
  chatView: {
    ...
    searchingMessages: '正在搜索…',
    searchResultsLimited: '仅显示前 {count} 条结果',
    searchResultsCount: '共找到 {count} 条结果',
    noMessageMatchesTitle: '没有匹配的消息',
    noMessageMatchesDescription: '换个关键词试试。',
    loadEarlierMessages: '加载更早的 {count} 条消息',
    copyMessageText: '复制文本',
    copyMessageEnvelope: '复制密文',
    deleteMessage: '删除消息',
    retrySend: '重试发送',
    cancelSend: '取消发送',
    jumpToLatest: '查看最新消息',
    ...
    unblock: '解除拉黑',
    incomingRecoveryTitle: '{count} 条消息暂时无法处理',
    recoverSession: '恢复安全会话',
    retryIncoming: '重试接收',
    sessionRecoveryWaiting: '正在等待对方响应安全会话恢复；恢复后请对方重发这些旧消息。',
    sessionRecoveryComplete: '安全会话已恢复，但这些旧消息无法解密；请让对方重发，或忽略旧消息。',
    ignoreOldMessages: '忽略旧消息',
    outgoingQueued: '待发送',
    outgoingMailbox: '待收取',
    outgoingSent: '已发送',
    ...
    conversationPending: '{count} 条待发送',
    conversationFailed: '{count} 条发送失败',
    retryConversation: '重试该会话待发送消息',
    retry: '重试',
    cancel: '取消',
    image: '图片',
    pdf: 'PDF',
    ...
    attachmentNeedsRedecryptHint: '页面刷新后需要重新解密，才能预览或下载。',
    attachmentDecryptFailed: '暂时无法解密，请确认身份文件和提示词后重试。',
    retryDecryptFile: '重试解密',
    download: '下载',
  ...
  contactsView: {
    ...
    searchingContacts: '正在搜索…',
    searchResultsLimited: '仅显示前 {count} 个联系人',
    searchResultsCount: '共找到 {count} 个联系人',
    ...
    scanInvalidCard: '无法识别为有效的好友名片二维码。',
    scanPermissionDenied: '摄像头权限被拒绝，请在浏览器设置中允许后重试。',
    scanNoCamera: '当前设备没有可用摄像头；可从相册选择二维码图片。',
    scanCameraUnavailable: '无法访问摄像头；可从相册选择二维码图片。',
    scanNeedsSecureContext: '扫码需要安全连接。请使用 HTTPS 或 localhost 访问。',
    scanImageNotFound: '图片中未识别到二维码。',
    scanImageFailed: '无法识别该图片，请换一张清晰的二维码图片。',
    contactDetail: '联系人详情',
    sendMessage: '发消息',
    securityStatus: '安全状态',
    ...
    readReceipts: '已读回执',
    readReceiptsDescription: '开启后，在你查看对方消息时会向对方发送已读状态。',
    readReceiptsEnabled: '已开启已读回执',
    enableReadReceipts: '开启已读回执',
    viewCard: '查看名片',
    friendIdentity: '好友身份',
    block: '拉黑',
    unblock: '解除拉黑',
    ...
    groupInvites: '群聊邀请',
    groupInvitesIcon: '👥',
    openGroupInvites: '打开群聊邀请',
    noGroupInvitesTitle: '暂无群聊邀请',
    noGroupInvitesDescription: '收到的群聊邀请会显示在这里。',
    groupNameFallback: '未命名群聊',
    inviteFrom: '来自 {name}',
    joinGroup: '加入',
    ignoreInvite: '忽略',
  },
