...
test('设置页可导出并导入完整数据备份恢复本地同步设置', async ({ page }) => {
  ...
  await page.getByLabel('DHT 操作历史 JSON').fill(JSON.stringify({ dht: { operation_history: ['2026/07/16 10:20 · DHT 查找：导入测试', '2026/07/16 10:21 · DHT 查找：[已脱敏]', '2026/07/16 10:22 · DHT 查找：... [已截断]'] } }))
