...
2. **DHT scaffold 演进**
   ...
   - [ ] 接入真正网络 find_node/find_value/store RPC。
   - [ ] closest-k replication 到远端节点与 routing table refresh。
