...
5. **Mailbox 收取与处理产品化**
   ...
   - 仍需失败重试队列、更细错误分类详情和长期 dedupe 保留/跨设备策略。
...
4. **群聊生命周期**
   ...
   - 仍需设计跨成员退群通知、移除成员后的双方视图、管理员权限失败提示和本地群视图冲突处理。
...
9. **可访问性与国际化**
   ...
   - Web 聊天消息、聊天列表、群事件摘要和诊断日志时间已使用 `zh-CN` 小时/分钟格式。
