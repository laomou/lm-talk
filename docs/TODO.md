...
8. **诊断报告规范**
   - 定义诊断报告包含哪些网络、节点、存储、版本信息。
   - 明确禁止包含私钥、提示词、消息明文、完整联系人名片。
   - 设计用户分享诊断报告给开发者前的预览和确认。
